...
#if MAX_MON_ITEMS > 1
SINGLE_BATTLE_TEST("Custap Berry allows the holder to move first in its priority bracket when HP is below 1/4 (Items)")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Custap Berry allows the holder to move first in its priority bracket when HP is below 1/2. If the holder has Gluttony (Items)")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Custap Berry activates even if the opposing mon switches out (Items)")
{
    GIVEN {
