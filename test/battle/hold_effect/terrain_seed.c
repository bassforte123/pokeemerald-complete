...
#if MAX_MON_ITEMS > 1
SINGLE_BATTLE_TEST("Electric Seed raises the holder's Defense on Electric Terrain (Items)")
{
    enum Ability ability;
    enum Item item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
...
SINGLE_BATTLE_TEST("Grassy Seed raises the holder's Defense on Grassy Terrain (Items)")
{
    enum Ability ability;
    enum Item item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
...
SINGLE_BATTLE_TEST("Misty Seed raises the holder's Sp. Defense on Misty Terrain (Items)")
{
    enum Ability ability;
    enum Item item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
...
SINGLE_BATTLE_TEST("Psychic Seed raises the holder's Sp. Defense on Psychic Terrain (Items)")
{
    enum Ability ability;
    enum Item item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
...
SINGLE_BATTLE_TEST("Seeds get consumed in Terrain even if holder is not affected by Terrain (Items)")
{
    u32 species, item;
    enum Ability ability;
    PARAMETRIZE { species = SPECIES_TAPU_KOKO; ability = ABILITY_ELECTRIC_SURGE; item = ITEM_ELECTRIC_SEED; }
...
SINGLE_BATTLE_TEST("Electric Seed is consumed on Electric Terrain before other abilities change the terrain (Items)")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Electric Seed doesn't activate on existing Electric Terrain before user's ability changes the terrain (Items)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
