...
SINGLE_BATTLE_TEST("Eject Button will not activate under Substitute")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_RAICHU) { Items(ITEM_EJECT_BUTTON); }
        OPPONENT(SPECIES_WOBBUFFET);
    } WHEN {
        TURN {
...
{
    GIVEN {
        PLAYER(SPECIES_REGIELEKI) { Items(ITEM_EJECT_BUTTON); }
        PLAYER(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("Eject Button is activated before Emergency Exit")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_GOLISOPOD) { Ability(ABILITY_EMERGENCY_EXIT); Items(ITEM_EJECT_BUTTON); }
        OPPONENT(SPECIES_WOBBUFFET);
    } WHEN {
        TURN {
...
DOUBLE_BATTLE_TEST("Eject Button activation will not trigger an attack from the incoming mon")
{
    GIVEN {
        ...
        PLAYER(SPECIES_WOBBUFFET) { Speed(100); Items(ITEM_EJECT_BUTTON); }
        PLAYER(SPECIES_DONDOZO) { Speed(20); }
        OPPONENT(SPECIES_WOBBUFFET) { Speed(50); Items(ITEM_EJECT_PACK); }
...
SINGLE_BATTLE_TEST("Eject Button activates after Wandring Spirit")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_YAMASK_GALAR) { Items(ITEM_EJECT_BUTTON); Ability(ABILITY_WANDERING_SPIRIT); }
    } WHEN {
        TURN {
            SWITCH(opponent, 1);
...
SINGLE_BATTLE_TEST("Eject Button will not activate under Substitute (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("Eject Button is not triggered after the mon loses Eject Button (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_RAICHU);
        OPPONENT(SPECIES_WOBBUFFET) { Items(ITEM_PECHA_BERRY, ITEM_EJECT_BUTTON); }
...
SINGLE_BATTLE_TEST("Eject Button has no chance to activate after Dragon Tail (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_KOMMO_O);
        OPPONENT(SPECIES_WOBBUFFET) { Items(ITEM_PECHA_BERRY, ITEM_EJECT_BUTTON); }
...
SINGLE_BATTLE_TEST("Eject Button prevents Volt Switch / U-Turn from activating (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_MANECTRIC);
        PLAYER(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("Eject Button is not triggered after High Jump Kick crash damage (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_WOBBUFFET) { Items(ITEM_PECHA_BERRY, ITEM_EJECT_BUTTON); }
