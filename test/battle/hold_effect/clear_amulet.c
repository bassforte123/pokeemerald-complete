...
SINGLE_BATTLE_TEST("Clear Amulet prevents stat reducing effects (Multi)")
{
    u32 move;
...
SINGLE_BATTLE_TEST("Clear Amulet prevents secondary effects that reduce stats (Multi)")
{
    u32 move;
...
SINGLE_BATTLE_TEST("Clear Amulet protects from Protect's secondary effects (Multi)")
{
    u32 move;
