...
#if MAX_MON_TRAITS > 1
SINGLE_BATTLE_TEST("Micle Berry raises the holder's accuracy by 1.2 when HP drops to 1/2 or below (Traits)")
{
    GIVEN {
...
#if MAX_MON_ITEMS > 1
SINGLE_BATTLE_TEST("Micle Berry raises the holder's accuracy by 1.2 when HP drops to 1/4 or below (Items)")
{
    enum Move move;
...
SINGLE_BATTLE_TEST("Micle Berry raises the holder's accuracy by 1.2 when HP drops to 1/2 or below (Items)")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Micle Berry increases the accuracy of the next used move across turns (Items)")
{
    GIVEN {
        ASSUME(GetMoveAccuracy(MOVE_ROCK_SLIDE) == 90);
        PASSES_RANDOMLY(100, 100, RNG_ACCURACY);
...
SINGLE_BATTLE_TEST("Micle Berry increases the accuracy of the next used move the same turn the berry was triggered (Items)")
{
    GIVEN {
        ASSUME(GetMoveAccuracy(MOVE_ROCK_SLIDE) == 90);
        PASSES_RANDOMLY(100, 100, RNG_ACCURACY);
