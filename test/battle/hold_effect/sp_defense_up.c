...
#if MAX_MON_TRAITS > 1
SINGLE_BATTLE_TEST("Apicot Berry raises Sp. Def by one stage when HP drops to 1/2 or below if holder has Gluttony (Traits)")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Apicot Berry raises Sp. Def by one stage when HP drops to 1/4 or below if holder has Ripen (Traits)")
{
    GIVEN {
