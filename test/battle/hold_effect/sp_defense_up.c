...
#if MAX_MON_ITEMS > 1
SINGLE_BATTLE_TEST("Apicot Berry raises the holder's Sp. Def by one stage when HP drops to 1/4 or below (Items)")
{
    enum Move move;
...
SINGLE_BATTLE_TEST("Apicot Berry raises Sp. Def by one stage when HP drops to 1/2 or below if holder has Gluttony (Items)")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Apicot Berry raises Sp. Def by one stage when HP drops to 1/4 or below if holder has Ripen (Items)")
{
    GIVEN {
