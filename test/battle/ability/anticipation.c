...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Judgment")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_ARCEUS) { Items(ITEM_FIST_PLATE); Moves(MOVE_JUDGMENT, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Natural Gift")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_WOBBUFFET) { Items(ITEM_LEPPA_BERRY); Moves(MOVE_NATURAL_GIFT, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Techno Blast")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_GENESECT) { Items(ITEM_BURN_DRIVE); Moves(MOVE_TECHNO_BLAST, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Multi-Attack")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_SILVALLY) { Items(ITEM_FIGHTING_MEMORY); Moves(MOVE_MULTI_ATTACK, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats Hidden Power as its dynamic type (Gen6+)")
{
    ...
    GIVEN {
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 0) == TYPE_NORMAL);
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); Items(ITEM_CHOPLE_BERRY); }
...
SINGLE_BATTLE_TEST("Anticipation doesn't consider Normalize into their effectiveness (Gen5+) (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_DELCATTY) { Ability(ABILITY_CUTE_CHARM); Innates(ABILITY_NORMALIZE); Moves(MOVE_CLOSE_COMBAT, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation doesn't consider Scrappy into their effectiveness (Gen5+) (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_DOUBLADE, 0) == TYPE_STEEL);
        ASSUME(GetSpeciesType(SPECIES_DOUBLADE, 1) == TYPE_GHOST);
        PLAYER(SPECIES_DOUBLADE) { Ability(ABILITY_NO_GUARD); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_KANGASKHAN) { Ability(ABILITY_EARLY_BIRD); Innates(ABILITY_SCRAPPY); Moves(MOVE_CLOSE_COMBAT, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation doesn't consider Gravity into their effectiveness (Gen5+) (Multi)")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Moves(MOVE_EARTHQUAKE, MOVE_GRAVITY, MOVE_SCRATCH, MOVE_POUND); }
    } WHEN {
...
SINGLE_BATTLE_TEST("Anticipation counts Counter, Metal Burst or Mirror Coat as attacking moves of their types (Gen5+) (Multi)")
{
    ...
    GIVEN {
        ...
        ASSUME(GetSpeciesType(species, 0) == typeDef);
        ASSUME(GetSpeciesType(species, 1) == typeDef);
        PLAYER(species) { Ability(ABILITY_LIGHT_METAL); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Moves(move, MOVE_SKILL_SWAP, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation considers Synchronoise as an ordinary Psychic-type move (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 0) != TYPE_POISON);
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) != TYPE_POISON);
        PLAYER(SPECIES_NIDORINO) { Ability(ABILITY_POISON_POINT); Innates(ABILITY_ANTICIPATION); Moves(MOVE_SYNCHRONOISE, MOVE_SKILL_SWAP, MOVE_POUND, MOVE_CELEBRATE); }
        OPPONENT(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Moves(MOVE_SYNCHRONOISE, MOVE_SKILL_SWAP, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation considers Freeze-Dry as an ordinary Ice-type move (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_SQUIRTLE, 0) == TYPE_WATER);
        ASSUME(GetSpeciesType(SPECIES_SQUIRTLE, 1) == TYPE_WATER);
        PLAYER(SPECIES_SQUIRTLE) { Ability(ABILITY_TORRENT); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Moves(MOVE_FREEZE_DRY, MOVE_SKILL_SWAP, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation considers Flying Press as an ordinary Fighting-type move (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_TANGELA, 0) == TYPE_GRASS);
        ASSUME(GetSpeciesType(SPECIES_TANGELA, 1) == TYPE_GRASS);
        PLAYER(SPECIES_TANGELA) { Ability(ABILITY_REGENERATOR); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Moves(MOVE_FLYING_PRESS, MOVE_SKILL_SWAP, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation considers Aura Wheel as an ordinary Electric-type move (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_PONYTA_GALAR, 1) == TYPE_PSYCHIC);
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_PONYTA_GALAR) { Ability(ABILITY_RUN_AWAY); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_MORPEKO) { Ability(ABILITY_LIGHT_METAL); Innates(ABILITY_HUNGER_SWITCH); Moves(MOVE_AURA_WHEEL, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { MOVE(player, MOVE_CELEBRATE); MOVE(opponent, MOVE_CELEBRATE); }
        TURN { SWITCH(player, 1); }
    } SCENE {
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Weather Ball (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_FERROTHORN, 0) == TYPE_GRASS);
        ASSUME(GetSpeciesType(SPECIES_FERROTHORN, 1) == TYPE_STEEL);
        PLAYER(SPECIES_FERROTHORN) { Ability(ABILITY_IRON_BARBS); Innates(ABILITY_ANTICIPATION); Speed(2); }
        OPPONENT(SPECIES_NINETALES) { Ability(ABILITY_FLASH_FIRE); Innates(ABILITY_DROUGHT); Moves(MOVE_WEATHER_BALL, MOVE_SKILL_SWAP, MOVE_POUND, MOVE_CELEBRATE); Speed(4); }
    } WHEN {
        TURN { }
    } SCENE {
        ABILITY_POPUP(opponent, ABILITY_DROUGHT);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Techno Blast (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_FERROTHORN, 0) == TYPE_GRASS);
        ASSUME(GetSpeciesType(SPECIES_FERROTHORN, 1) == TYPE_STEEL);
        PLAYER(SPECIES_FERROTHORN) { Ability(ABILITY_IRON_BARBS); Innates(ABILITY_ANTICIPATION); }
...
SINGLE_BATTLE_TEST("Anticipation does not consider Strong Winds on type matchups (Multi)")
{
    GIVEN {
        ASSUME(GetSpeciesType(SPECIES_RAYQUAZA_MEGA, 0) == TYPE_DRAGON);
        ASSUME(GetSpeciesType(SPECIES_RAYQUAZA_MEGA, 1) == TYPE_FLYING);
        PLAYER(SPECIES_RAYQUAZA) { Ability(ABILITY_LIGHT_METAL); Innates(ABILITY_ANTICIPATION); Moves(MOVE_DRAGON_ASCENT, MOVE_CELEBRATE); }
        OPPONENT(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Moves(MOVE_ROCK_SLIDE, MOVE_SKILL_SWAP, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
...
SINGLE_BATTLE_TEST("Anticipation does not consider ate-abilities (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_WORMADAM_PLANT, 0) == TYPE_BUG);
        ASSUME(GetSpeciesType(SPECIES_WORMADAM_PLANT, 1) == TYPE_GRASS);
        PLAYER(SPECIES_WORMADAM_PLANT) { Ability(ABILITY_OVERCOAT); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_AURORUS) { Ability(ABILITY_SNOW_WARNING); Innates(ABILITY_REFRIGERATE); Moves(MOVE_GROWL, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats Hidden Power as its dynamic type (Gen6+) (Multi)")
{
    ...
    GIVEN {
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 0) == TYPE_NORMAL);
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ADAPTABILITY); Innates(ABILITY_ANTICIPATION); Item(ITEM_CHOPLE_BERRY); }
        OPPONENT(SPECIES_WOBBUFFET) { Moves(MOVE_HIDDEN_POWER, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); HPIV(30); AttackIV(2); DefenseIV(31); SpAttackIV(30); SpDefenseIV(30); SpeedIV(30); }
    } WHEN {
        TURN { MOVE(opponent, MOVE_HIDDEN_POWER); }
    } SCENE {
...
SINGLE_BATTLE_TEST("Anticipation considers Inverse Battle types (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_FERROTHORN, 0) == TYPE_GRASS);
        ASSUME(GetSpeciesType(SPECIES_FERROTHORN, 1) == TYPE_STEEL);
        PLAYER(SPECIES_FERROTHORN) { Ability(ABILITY_ADAPTABILITY); Innates(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_WOBBUFFET) { Moves(MOVE_GROWL, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Judgment (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_ARCEUS) { Items(ITEM_ORAN_BERRY, ITEM_FIST_PLATE); Moves(MOVE_JUDGMENT, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Natural Gift (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_WOBBUFFET) { Items(ITEM_ORAN_BERRY, ITEM_LEPPA_BERRY); Moves(MOVE_NATURAL_GIFT, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Techno Blast (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_FERROTHORN, 1) == TYPE_STEEL);
        PLAYER(SPECIES_FERROTHORN) { Ability(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_GENESECT) { Items(ITEM_ORAN_BERRY, ITEM_BURN_DRIVE); Moves(MOVE_TECHNO_BLAST, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Multi-Attack (Multi)")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); }
        OPPONENT(SPECIES_SILVALLY) { Items(ITEM_ORAN_BERRY, ITEM_FIGHTING_MEMORY); Moves(MOVE_MULTI_ATTACK, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); }
    } WHEN {
        TURN { }
    } SCENE {
        NOT ABILITY_POPUP(player, ABILITY_ANTICIPATION);
...
SINGLE_BATTLE_TEST("Anticipation treats Hidden Power as its dynamic type (Gen6+) (Multi)")
{
    ...
    GIVEN {
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 0) == TYPE_NORMAL);
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) == TYPE_NORMAL);
        PLAYER(SPECIES_EEVEE) { Ability(ABILITY_ANTICIPATION); Items(ITEM_ORAN_BERRY, ITEM_CHOPLE_BERRY); }
        OPPONENT(SPECIES_WOBBUFFET) { Moves(MOVE_HIDDEN_POWER, MOVE_SCRATCH, MOVE_POUND, MOVE_CELEBRATE); HPIV(30); AttackIV(2); DefenseIV(31); SpAttackIV(30); SpDefenseIV(30); SpeedIV(30); }
    } WHEN {
        TURN { MOVE(opponent, MOVE_HIDDEN_POWER); }
    } SCENE {
