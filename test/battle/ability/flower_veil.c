...
TO_DO_BATTLE_TEST("Flower Veil's stat reduction protection considers Contrary (Traits)") // Eg. If a move would reduce stats due to Contrary, it will be protected by Mist.
#endif
=======
