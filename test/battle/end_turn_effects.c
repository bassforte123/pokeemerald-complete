...
MULTI_BATTLE_TEST("End Turn Effects: First Event Block is executed correctly (multibattle) (Traits)")
{
    ...
    GIVEN {
        PLAYER(SPECIES_WYNAUT) { HP(100); Speed(1); }
        PARTNER(SPECIES_EKANS) { HP(100); Ability(ABILITY_INTIMIDATE); Innates(ABILITY_SHED_SKIN); Status1(STATUS1_BURN); Speed(2); }
        OPPONENT_A(SPECIES_WYNAUT) { HP(100); Item(ITEM_LEFTOVERS); Speed(3); }
        OPPONENT_B(SPECIES_WOBBUFFET) { HP(100); Item(ITEM_BLACK_SLUDGE); Speed(4); }
    } WHEN {
        TURN { MOVE(playerLeft, MOVE_GRASSY_TERRAIN); }
...
#if MAX_MON_ITEMS > 1
DOUBLE_BATTLE_TEST("End Turn Effects: First Event Block is executed correctly (double battle) (Items)")
{
    s16 healed;
    s16 damage;
    ...
    GIVEN {
        PLAYER(SPECIES_WYNAUT) { HP(100); Speed(1); }
        PLAYER(SPECIES_EKANS) { HP(100); Ability(ABILITY_SHED_SKIN); Status1(STATUS1_BURN); Speed(2); }
        OPPONENT(SPECIES_WYNAUT) { HP(100); Items(ITEM_ORAN_BERRY, ITEM_LEFTOVERS); Speed(3); }
        OPPONENT(SPECIES_WOBBUFFET) { HP(100); Items(ITEM_ORAN_BERRY, ITEM_BLACK_SLUDGE); Speed(4); }
    } WHEN {
        TURN { MOVE(playerLeft, MOVE_GRASSY_TERRAIN); }
    } SCENE {
        MESSAGE("The opposing Wobbuffet is healed by the grassy terrain!");
...
MULTI_BATTLE_TEST("End Turn Effects: First Event Block is executed correctly (multibattle) (Items)")
{
    s16 healed;
    s16 damage;
    ...
    GIVEN {
        PLAYER(SPECIES_WYNAUT) { HP(100); Speed(1); }
        PARTNER(SPECIES_EKANS) { HP(100); Ability(ABILITY_SHED_SKIN); Status1(STATUS1_BURN); Speed(2); }
        OPPONENT_A(SPECIES_WYNAUT) { HP(100); Items(ITEM_ORAN_BERRY, ITEM_LEFTOVERS); Speed(3); }
        OPPONENT_B(SPECIES_WOBBUFFET) { HP(100); Items(ITEM_ORAN_BERRY, ITEM_BLACK_SLUDGE); Speed(4); }
    } WHEN {
        TURN { MOVE(playerLeft, MOVE_GRASSY_TERRAIN); }
    } SCENE {
        MESSAGE("The opposing Wobbuffet is healed by the grassy terrain!");
...
TWO_VS_ONE_BATTLE_TEST("End Turn Effects: First Event Block is executed correctly (2v1) (Items)")
{
    s16 healed;
    s16 damage;
    ...
    GIVEN {
        ...
        PARTNER(SPECIES_EKANS) { HP(100); Ability(ABILITY_SHED_SKIN); Status1(STATUS1_BURN); Speed(2); }
        OPPONENT_A(SPECIES_WYNAUT) { HP(100); Items(ITEM_ORAN_BERRY, ITEM_LEFTOVERS); Speed(3); }
        OPPONENT_A(SPECIES_WOBBUFFET) { HP(100); Items(ITEM_ORAN_BERRY, ITEM_BLACK_SLUDGE); Speed(4); }
    } WHEN {
        TURN { MOVE(playerLeft, MOVE_GRASSY_TERRAIN); }
    } SCENE {
        MESSAGE("The opposing Wobbuffet is healed by the grassy terrain!");
...
ONE_VS_TWO_BATTLE_TEST("End Turn Effects: First Event Block is executed correctly (1v2) (Items)")
{
    s16 healed;
    s16 damage;
