...
#include "test/battle.h"
                                                                ...
                                                                // Ceilings increased to 3x to account for Multi processing time. (Multi)
#define AI_FRAME_CEILING_SINGLES_NO_FLAGS                       9
#define AI_FRAME_CEILING_SINGLES_SMART_TRAINER                  24
#define AI_FRAME_CEILING_DOUBLES_NO_FLAGS                       63
#define AI_FRAME_CEILING_DOUBLES_SMART_TRAINER                  111
#define AI_FRAME_CEILING_STEVEN_MULTI                           81
#define AI_FRAME_CEILING_STEVEN_MULTI_SMART_TRAINER             90
