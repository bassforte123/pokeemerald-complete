...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 101-200 (Items)")
{
    enum Move moveStart = 100;
    enum Move moveCap = 200;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 201-300 (Items)")
{
    enum Move moveStart = 200;
    enum Move moveCap = 300;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 301-400 (Items)")
{
    enum Move moveStart = 300;
    enum Move moveCap = 400;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 401-500 (Items)")
{
    enum Move moveStart = 400;
    enum Move moveCap = 500;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 501-600 (Items)")
{
    enum Move moveStart = 515;
    enum Move moveCap = 600;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 601-700 (Items)")
{
    enum Move moveStart = 600;
    enum Move moveCap = 700;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 701-800 (Items)")
{
    enum Move moveStart = 700;
    enum Move moveCap = 800;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 801-900 (Items)")
{
    enum Move moveStart = 800;
    enum Move moveCap = 900;
