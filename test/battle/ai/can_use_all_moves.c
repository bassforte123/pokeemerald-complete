...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 1-100")
{
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_WOBBUFFET) { Moves(MOVE_SPLASH, move); Status1(STATUS1_BURN); Items(ITEM_STARF_BERRY); }
        OPPONENT(SPECIES_WOBBUFFET) { Moves(MOVE_POUND, move); Items(ITEM_STARF_BERRY); }
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 101-200 (Multi)")
{
    u32 moveStart = 100;
    u32 moveCap = 200;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 201-300 (Multi)")
{
    u32 moveStart = 200;
    u32 moveCap = 300;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 301-400 (Multi)")
{
    u32 moveStart = 300;
    u32 moveCap = 400;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 401-500 (Multi)")
{
    u32 moveStart = 400;
    u32 moveCap = 500;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 501-600 (Multi)")
{
    u32 moveStart = 515;
    u32 moveCap = 600;
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_WOBBUFFET) { Moves(MOVE_SPLASH, move); Status1(STATUS1_BURN); Items(ITEM_NONE, ITEM_STARF_BERRY); }
        OPPONENT(SPECIES_WOBBUFFET) { Moves(MOVE_POUND, move); Items(ITEM_PECHA_BERRY, ITEM_STARF_BERRY); }
        OPPONENT(SPECIES_WOBBUFFET) { Status1(STATUS1_BURN); }
        OPPONENT(SPECIES_WOBBUFFET);
    } WHEN {
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 601-700 (Multi)")
{
    u32 moveStart = 600;
    u32 moveCap = 700;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 701-800 (Multi)")
{
    u32 moveStart = 700;
    u32 moveCap = 800;
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 801-900 (Multi)")
{
    u32 moveStart = 800;
    u32 moveCap = 900;
