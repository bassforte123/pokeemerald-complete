...
DOUBLE_BATTLE_TEST("Razor Wind successfully KOs both opponents (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { Items(ITEM_PECHA_BERRY, ITEM_POWER_HERB); }
        PLAYER(SPECIES_WYNAUT);
...
SINGLE_BATTLE_TEST("Skull Bash doesn't need to charge with Power Herb (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { Items(ITEM_PECHA_BERRY, ITEM_POWER_HERB); }
        OPPONENT(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("Sky Attack doesn't need to charge with Power Herb (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { Items(ITEM_PECHA_BERRY, ITEM_POWER_HERB); }
        OPPONENT(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("Solar Beam's power is halved in a Sandstorm (Multi)", s16 damage)
{
    u16 move;
    PARAMETRIZE { move = MOVE_CELEBRATE; }
    PARAMETRIZE { move = MOVE_SANDSTORM; }
...
SINGLE_BATTLE_TEST("Solar Blade's power is halved in a Sandstorm (Multi)", s16 damage)
{
    u16 move;
    PARAMETRIZE { move = MOVE_CELEBRATE; }
    PARAMETRIZE { move = MOVE_SANDSTORM; }
...
SINGLE_BATTLE_TEST("Solar Beam's power is halved in Hail (Multi)", s16 damage)
{
    u16 move;
    PARAMETRIZE { move = MOVE_CELEBRATE; }
    PARAMETRIZE { move = MOVE_HAIL; }
...
SINGLE_BATTLE_TEST("Solar Blade's power is halved in Hail (Multi)", s16 damage)
{
    u16 move;
    PARAMETRIZE { move = MOVE_CELEBRATE; }
    PARAMETRIZE { move = MOVE_HAIL; }
...
SINGLE_BATTLE_TEST("Electro Shot doesn't need to charge with Power Herb (Multi)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { Items(ITEM_PECHA_BERRY, ITEM_POWER_HERB); }
        OPPONENT(SPECIES_WOBBUFFET);
