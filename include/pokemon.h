...
struct BattlePokemon
{
    ...
    u8 friendship;
    u16 maxHP;
    enum Item items[MAX_MON_ITEMS_INTERNAL]; //Set to at least 2 for this standalone mod branch
    ...
    enum Item item; //Only to allow vanilla tests to pass without errors
};
