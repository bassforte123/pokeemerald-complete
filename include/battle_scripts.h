...
extern const u8 BattleScript_AbilityStatChangeATK[];
extern const u8 BattleScript_AbilityStatChangeDEF[];
extern const u8 BattleScript_AbilityStatChangeDEF2[];
extern const u8 BattleScript_AbilityStatChangeSPATK[];
extern const u8 BattleScript_AbilityStatChangeSPDEF[];
extern const u8 BattleScript_AbilityStatChangeSPEED[];
extern const u8 BattleScript_AbilityStatChangeSPEED6[];
extern const u8 BattleScript_AbilityStatChangeAttackerSpeedDown[];
extern const u8 BattleScript_AbilityStatChangeAngerPoint[];
extern const u8 BattleScript_AbilityStatChangeAngerShell[];
extern const u8 BattleScript_AngerShellActivates[];
extern const u8 BattleScript_AbilityStatChangeWeakArmor[];
extern const u8 BattleScript_AbilityStatChangeBeastBoost[];
