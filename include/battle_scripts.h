...
extern const u8 BattleScript_TeravoltActivates[];
extern const u8 BattleScript_TurboblazeActivates[];
...
extern const u8 BattleScript_TargetItemStatRaise_Snowball[];
extern const u8 BattleScript_TargetItemStatRaise_Luminous_Moss[];
extern const u8 BattleScript_TargetItemStatRaise_Cell_Battery[];
extern const u8 BattleScript_TargetItemStatRaise_Absorb_Bulb[];
...
extern const u8 BattleScript_AirBaloonIronBallMsgIn[];
...
extern const u8 BattleScript_FriskMsg2[];
extern const u8 BattleScript_FriskMsg3[];
...
extern const u8 BattleScript_BattlerAbilityStatRaiseOnSwitchInIntrepid[];
extern const u8 BattleScript_BattlerAbilityStatRaiseOnSwitchInDauntless[];
...
extern const u8 BattleScript_BattlerAbilityStatRaiseOnSwitchInEmbodyAspectCornerStone[];
...
extern const u8 BattleScript_RaiseStatOnFaintingTargetMoxie[];
extern const u8 BattleScript_RaiseStatOnFaintingTargetChilling[];
extern const u8 BattleScript_RaiseStatOnFaintingTargetGrim[];
extern const u8 BattleScript_RaiseStatOnFaintingTargetBeastBoost[];
extern const u8 BattleScript_AttackerDownloadStatRaise[];
...
extern const u8 BattleScript_TargetAbilityStatRaiseRetJustified[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetRattled[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetWaterCompaction[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetStamina[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetBerserk[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetSteam[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetThermal[];
