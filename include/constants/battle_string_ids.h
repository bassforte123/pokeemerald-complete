...
enum StringID
{
    ...
    STRINGID_STATSWONTINCREASECONTRARY2,
    ...
    STRINGID_PKMNINTIMIDATECONTRARYRATTLED,
    ...
    STRINGID_STATSWONTDECREASECONTRARY2,
    ...
    STRINGID_FRISKACTIVATES2,
    STRINGID_FRISKACTIVATES3,
    ...
    STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSPATK,
    STRINGID_ABILITYWEAKENEDSURROUNDINGMONSDEF,
    STRINGID_ABILITYWEAKENEDSURROUNDINGMONSATK,
    STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSPDEF,
