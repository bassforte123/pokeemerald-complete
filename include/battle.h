...
struct SpecialStatus
{
    ...
    struct StatStages statStageQueue4[NUM_BATTLE_STATS];
    u8 statStageAmount3:4;
    u8 statStageAmount4:4;
};
...
struct BattleStruct
{
    ...
    struct LostItem itemLost[MAX_BATTLE_TRAINERS][PARTY_SIZE][MAX_MON_ITEMS];  // Pokemon that had items consumed or stolen (two bytes per party member per side per item slot)
